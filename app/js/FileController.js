...
module.exports = (FileController = {
	...
	getFile(req, res){
		...
		metrics.inc("getFile");
		logger.log({key, bucket, format, style}, "reciving request to get file");
	...
	insertFile(req, res){
		...
		const {key, bucket} = req;
		logger.log({key, bucket}, "reciving request to insert file");
	...
	copyFile(req, res){
		...
		logger.log({key, bucket, oldProject_id, oldFile_id}, "reciving request to copy file");
	...
	deleteFile(req, res){
		...
		const {key, bucket} = req;
		logger.log({key, bucket},  "reciving request to delete file");
	...
	directorySize(req, res){
		...
		logger.log({project_id, bucket}, "reciving request to project size");
